...
const features = [
  {
    ...
    description: 'Scan any public repo instantly. Connect GitHub to scan your private repos too.',
    icon: '🔐',
  },
  {
              ...
              <div className="space-y-8">
                ...
                <div id="scanner" className="space-y-4">
                  ...
                  <div className="flex items-center gap-4 text-sm text-zinc-500">
                    <Link href="/login" className="hover:text-zinc-300 transition-colors flex items-center gap-1">
